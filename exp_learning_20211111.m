...
instructionStart=['You will be controlling two mice to do the task.'...
        ...
        '\n\n\n Starting point will turn green, when you had placed both pen on it. Then the trial will start.'...
        ...
        '\n\n\n You will not be able to see the position of your pens in red and blue dots during the trials.'...
        '\n\n\n But the dot will turn green when comes close to a trajectory line shown on the screen.'...
        '\n\n\n Try to coordinate the moving speed of your hands in the suggested ratio shown'...
        '\n\n\n Move the dot along the trajectory to the end of the line. Complete the movement within ' num2str(moveSecs) ' seconds.'...
        '\n\n\n Your can get higher score if perform more quickly and closely to the trajectory.'...
