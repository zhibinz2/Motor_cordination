...
time_series1_trials=zeros(trial_length,NumChans,NumTrials);
for i=1:NumTrials
    time_series1_trials(:,1:NumChans,i)=time_series1(:,stamp1index_Trial_Start(i):stamp1index_Trial_Start(i)+trial_length-1)';
end
time_series1_trials;
