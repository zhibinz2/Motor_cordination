...
%% PLOT 13 corr between power and Hurst all sessions
...
canvas(0.5,0.1);
cmin=-0.4;cmax=0.4;
subplot(1,5,1);topoplot(H_delta_LR_H_LR_corr,channels,'nosedir','+X');title('H-delta & H-int');colorbar;colormap('jet');clim([cmin cmax]);
subplot(1,5,2);topoplot(H_theta_LR_H_LR_corr,channels,'nosedir','+X');title('H-theta & H-int');colorbar;colormap('jet');clim([cmin cmax]);
subplot(1,5,3);topoplot(H_alpha_LR_H_LR_corr,channels,'nosedir','+X');title('H-alpha & H-int');colorbar;colormap('jet');clim([cmin cmax]);
