while n <  numFrames %~KbCheck
    ...
    % Draw the route
    Screen('DrawDots', windowPtr, PosL, Thickness, Color, [0 0], 2);
    % Draw the connecting points
    Screen('DrawDots', windowPtr, PosL0, ConnectDotSize, ConnectDotColor0, [0 0], 2);
    Screen('DrawDots', windowPtr, PosL1, ConnectDotSize, ConnectDotColor1, [0 0], 2);
    Screen('DrawDots', windowPtr, PosL2, ConnectDotSize, ConnectDotColor2, [0 0], 2);
    Screen('DrawDots', windowPtr, PosL3, ConnectDotSize, ConnectDotColor3, [0 0], 2);
...
%     Screen('FillRect', windowPtr, rectColor, centeredRect);
    ...
    inside0 = IsInDot(xM, yM, PosL0, ConnectDotSize);
    if inside0 == 1
        ConnectDotColor0 = red;
    elseif inside0 == 0
        ConnectDotColor0 = blue;
    end
    inside1 = IsInDot(xM, yM, PosL1, ConnectDotSize);
    if inside1 == 1
        ConnectDotColor1 = red;
    elseif inside1 == 0
        ConnectDotColor1 = blue;
    end
    inside2 = IsInDot(xM, yM, PosL2, ConnectDotSize);
    if inside2 == 1
        ConnectDotColor2 = red;
    elseif inside2 == 0
        ConnectDotColor2 = blue;
    end
    inside3 = IsInDot(xM, yM, PosL3, ConnectDotSize);
    if inside3 == 1
