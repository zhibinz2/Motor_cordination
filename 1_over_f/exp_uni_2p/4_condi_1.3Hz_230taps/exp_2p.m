...
% There are 4 (1.3Hz),each repeat 3 times, a total of 12 blocks; 230 taps each block
% This is the full length version
cd /home/hnl/Documents/GitHub/Motor_cordination/1_over_f/exp_uni_2p/4_condi_1.3Hz_230taps
...
%     end
    ...
    Showframes1=[1:NumFramesInterval13Hz:NumFramesInterval13Hz*30 zeros(1,570)]; 
    ...
    for block=1:numBlock
        ...
        for t=1:numTrials 
            ...
            DrawFormattedText2([ShowCondition ' -- block ' num2str(block) ' trial ' num2str(t)],'win',windowPtr,...
