...
%% PLOT 11 Xcorr slinding window of 20 intervals I(based on the matched invervals)
clear
seeds=[20220713;20220721;20220804;20220808;20220810;20220811;20220815;20220816];
sessions={'synch','synco','synch','synco','synch','synco','synch','synco'};
% sliding win
...
for s=1:8 % each session
    ...
    zEEG_L={};zEEG_R={};zEEG500_L={};zEEG500_R={};
    for b=1:12 % each block
        ...
        for i=1:size(samples{b},1) % each matched interval
            zEEG500_L{b}{i}=zEEG_L{b}(samples{b}(i,1)-999:samples{b}(i,1),:); % start from first matched tap (if not enough samples before, then consider starting from 2nd tap)
            zEEG500_R{b}{i}=zEEG_R{b}(samples{b}(i,2)-999:samples{b}(i,2),:);
            [delta_L{b}{i}, theta_L{b}{i}, alpha_L{b}{i}, beta_L{b}{i}, gamma_L{b}{i}]...
                =sum5band(zEEG500_L{b}{i},sr,EEGwin);
            [delta_R{b}{i}, theta_R{b}{i}, alpha_R{b}{i}, beta_R{b}{i}, gamma_R{b}{i}]...
                =sum5band(zEEG500_R{b}{i},sr,EEGwin);
        end
    end
end
