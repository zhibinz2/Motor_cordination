...
%% One-way ANOVA
[p,tbl,stats] = anova1(cat(2, ...
    [intervals_L_uncouple_synch intervals_R_uncouple_synch]', ...
    [intervals_L_uncouple_synco intervals_R_uncouple_synco]', ...
    [intervals_L_Llead_synch intervals_R_Rlead_synch]', ...
    [intervals_L_Llead_synco intervals_R_Rlead_synco]', ... 
    [intervals_R_Llead_synch intervals_L_Rlead_synch]', ...
    [intervals_R_Llead_synco intervals_L_Rlead_synco]', ...
    [intervals_L_mutual_synch intervals_R_mutual_synch]', ...
    [intervals_L_mutual_synco intervals_R_mutual_synco]' ...
    )); 
...
% Two-way ANOVA: p-task = 0, p-feedback = 0.14; Paired t-test for all four feedback conditions: p-task < 0.01 

%% Paired T test
[~,p]=ttest([intervals_L_uncouple_synch intervals_R_uncouple_synch]', [intervals_L_uncouple_synco intervals_R_uncouple_synco]')
[~,p]=ttest([intervals_L_Llead_synch intervals_R_Rlead_synch]', [intervals_L_Llead_synco intervals_R_Rlead_synco]')
[~,p]=ttest([intervals_R_Llead_synch intervals_L_Rlead_synch]', [intervals_R_Llead_synco intervals_L_Rlead_synco]')
[~,p]=ttest([intervals_L_mutual_synch intervals_R_mutual_synch]', [intervals_L_mutual_synco intervals_R_mutual_synco]')