...
%% PLOT 7 Autocorr summary in all sessions (unmatched int) (sorted order)
clear
seeds=[20220713;20220721;20220804;20220808;20220810;20220811;20220815;20220816;20221003;2022100401;
        2022100402;20221005];
numSes=size(seeds,1);
...
%% SECT 9 Xcorr after d removal and save new intervals (matched int) (sorted order) 
clear
Trials={'uncouple','uncouple','uncouple','L-lead','L-lead','L-lead',...
    'R-lead','R-lead','R-lead','mutual','mutual','mutual'}';
seeds=[20220713;20220721;20220804;20220808;20220810;20220811;20220815;20220816;20221003;2022100401;
...
%% PLOT 9 Xcorr after d removal and save new intervals (matched int) (sorted order) + ANOVA 
...
for c=1:32
    delta_LL_chan(:,c)=reshape(delta_LL_sum(:,:,c)',[],1); % 96x32 (each element from one block in time sequence) 
...
sgtitle('mean H-EEG (+ 500ms) for each condition');
% only H-EEG of beta and gamma show complexity (H>0.5)
...
sgtitle('corr of H-EEG (- 500ms) and H-interval')
...
% then stack them in 2-d " trials x (freq x chan)" 
H5forpls3=reshape(H5forpls2,5*32,192)'; % 192x160 elements extracted colums-wise
% (colums: delta chan1, theta chan 1, alpha chan1, beta chan1, gamma chan1, delta chan2...)
...
% combine 5 bands in a 3d matrix  "trials x chan x  freq" (96 x 64 x 5)
Band5_LR_chan64=cat(3,delta_LR_chan64,theta_LR_chan64,...
    alpha_LR_chan64,beta_LR_chan64,gamma_LR_chan64);
% switch dismenstion to "freq x chan x trials" (5 x 64 x 96)
Band5_LR_chan64_2=permute(Band5_LR_chan64,[3 2 1]);
% reshape into 96 trials x ( 5 freq x 64 chan)
% stack them in 2-d "trials x (freq x chan)"  (96 x 320)
Band5_LR_chan64_3=reshape(Band5_LR_chan64_2,5*64,96)';% 96x320 elements extracted colums-wise
% (colums: delta chan1, theta chan 1, alpha chan1, beta chan1, gamma chan1, delta chan2...)
