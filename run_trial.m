while n <  numFramesPlan+numFramesMove %~KbCheck 
    ...
    if n< numFramesPlan 
        ...
        Screen('DrawText', windowPtr, ['You have 3 sec to draw! Start drawing in 1 sec!'], xCenter-steplength, yCenter-steplength, white);
    end
